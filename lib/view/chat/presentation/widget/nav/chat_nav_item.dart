      ...
      child: ClipRRect(
        ...
        child: ListView.separated(
          ...
          itemBuilder: (context, index) {
            ...
            final lastMsg =
                conv.messages.isNotEmpty ? conv.messages.last : null;
            final sender = lastMsg?.authorId == currentUserId ? 'You: ' : '';

            final snippet = lastMsg != null
                ? (lastMsg is TextMessage
                    ? '$sender${lastMsg.text}'
                    : '$sender[${lastMsg.type.name}]')
                : '';
            final time =
