...
import 'package:employeeos/core/index.dart'
    show getExtensionFromMime, getFileIcon;
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: SvgPicture.asset(
              getFileIcon(getExtensionFromMime(item.mimeType)),
              height: 70,
            ),
          ),
          ...
          Text(item.sizeString, style: Theme.of(context).textTheme.bodyMedium),
          ...
          Container(
            ...
            child: Text(
              getExtensionFromMime(item.mimeType).toUpperCase(),
